...
| Parallélisme Dev par défaut en prod | 1, jusqu'à trois cycles verts à 2 (`SWARM_DEV_PARALLELISM`). **Atteint le 2026-09-25** : `9d3174f41829`, `d7a0e052f1ad` (tour-summary, trois PR), `b0251cf1141f` (#323, la PR #325 ramenée d'un conflit puis fusionnée), plus `ca002877ad71` propre sans rien à construire ; la prod passe à 2 dans `docker-compose.yml`. Depuis #227, la largeur 2 ne lance ensemble que des sous-tâches indépendantes |
